<div class="relative inline-block text-left" x-data="{ open: false }">
    ...
    <div class="z-40 origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 hidden" role="menu" aria-orientation="vertical" aria-labelledby="menu-button">
        <div class="py-1">
        <a href="#" class="text-gray-700 block px-4 py-2 text-sm hover:bg-gray-100" role="menuitem">Преглед</a>
            <a href="#" class="text-gray-700 block px-4 py-2 text-sm hover:bg-gray-100" role="menuitem">Редакция</a>
            <a href="#" class="text-red-600 block px-4 py-2 text-sm hover:bg-red-100" role="menuitem">Изтриване</a>
        </div>
    </div>
</div>
